    ...
    <div class="page-header">
      <div class="header-content">
        <div class="header-text">
          <h2>本地打印机</h2>
          <p>管理本地打印机和Lodop配置</p>
          <p class="usage-tip">💡 使用提示：你只需要在本页面配置本地的LODOP端口即可。本插件的运行架构是，如果你要打印东西，平台会将需要打印的内容传到这一个插件，然后这个插件再调用本地的下面配置的端口进行打印，所以只需要填写本地端口就可以了。因为LODOP远程打印的话是需要支付授权费的，所以如果你希望支持LODOP这个项目，你可以在他们的软件中付费。当然，无论你付费与否的话，都可以使用本插件进行打印，本插件只是一个打印的中间件，所以打印软件付费与否与本插件无关，本插件的功能是免费的。</p>
        </div>
      </div>
    </div>
